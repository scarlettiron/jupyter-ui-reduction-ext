...
const extension = {
    ...
    activate: (app) => {
        ...
        app.restored.then(() => {
            ...
            const workspace = document.querySelector('#jp-main-content-panel'); // The main content area
            if (workspace) {
            ...
            // Make the workspace full screen
            const dockPanel = document.querySelector('.jp-main-dock-panel');
            if (dockPanel) {
            ...
            // Make the workspace full screen
            const dockPanel2 = document.querySelector('#jp-main-dock-panel');
            if (dockPanel2) {
            ...
            if (mainPanel) {
                ...
                mainPanel.style.height = '100vh'; // Full height of the viewport
                // Adjust the parent container to ensure proper resizing
                const mainAreaWidget = document.querySelector('.jp-MainAreaWidget');
                if (mainAreaWidget) {
                ...
                const pipelineEditor = document.querySelector('.elyra-PipelineEditor');
                if (pipelineEditor) {
